...
# C++ Perceptron
C++ Perceptron (*cpp-perceptron*) is a small educational implementation of a binary perceptron in C++. The included demo trains the model to learn the logical AND gate.
